...
const generateMockRecordings = (): Recording[] => {
  const baseRecordings = [
    { name: 'Enterprise Demo - Acme Corp', dealContext: '$50k Pipeline', status: 'completed' as const },
    { name: 'Discovery Call - TechStart Inc', dealContext: '$25k Qualified', status: 'completed' as const },
    { name: 'Pricing Discussion - Global Solutions', dealContext: '$100k Negotiation', status: 'processing' as const },
    { name: 'Follow-up Call - Innovate Labs', dealContext: '$15k Closed Won', status: 'completed' as const },
    { name: 'Initial Outreach - DataFlow', dealContext: '$35k Discovery', status: 'error' as const },
    { name: 'Product Demo - CloudSync', dealContext: '$75k Pipeline', status: 'completed' as const },
    { name: 'Negotiation Call - Apex Systems', dealContext: '$120k Proposal', status: 'completed' as const },
    { name: 'Onboarding Review - StartupXYZ', dealContext: '$10k Closed Won', status: 'completed' as const },
    { name: 'Quarterly Review - MegaCorp', dealContext: '$200k Renewal', status: 'processing' as const },
    { name: 'Cold Outreach - NewVenture', dealContext: '$40k Lead', status: 'completed' as const },
  ];
  ...
  insights: [
    {
      ...
      critique: "You missed an opportunity to understand the competitive landscape when they mentioned 'several solutions'.",
      tryThisInstead: "Before we dive in, I'm curious - you mentioned looking at several solutions. What's been the deciding factor in your evaluations so far?",
    },
    {
      timestampSeconds: 95,
      endSeconds: 129,
      whatYouSaid: "Perfect, I'll definitely cover that. Our AI-powered coaching module has helped teams reduce their sales cycle by an average of 23%. Now, let me walk you through...",
      critique: "This turned into a long monologue. Check in with the prospect more frequently.",
      tryThisInstead: "Our coaching module has helped teams reduce sales cycles by 23%. Before I show you more, does that metric resonate with your goals?",
    },
    {
      timestampSeconds: 130,
      endSeconds: 154,
      whatYouSaid: "Great question about implementation...",
      critique: "Good job addressing the concern, but you could have asked clarifying questions about their specific timeline constraints.",
      tryThisInstead: "That's an important consideration. Is there a specific deadline you're working toward, or an event driving your timeline?",
    },
  ],
  objections: [
    {
